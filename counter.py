...
OSC_PLAY_ADDRESS = "/stagecounter/play"
OSC_STOP_ADDRESS = "/stagecounter/stop"
...
class SettingsDialog(QDialog):
    def __init__(self, parent):
        ...
        self.parent = parent
        self.setWindowTitle("StageCounter Settings")
        self.resize(580, 940)
        ...
        shortcut_label.setStyleSheet("color: #dddddd; padding-top: 12px;")
    ...
    def apply_settings(self):
        try:
            ...
            self.parent.spout_sender_name = self.spout_name_input.text().strip() or "StageCounter"
...
class TimerApp(QWidget):
    def __init__(self):
        ...
        self.spout_sender_name = "StageCounter"
        ...
        self.spout_status_label = QLabel("SPOUT ON", self)
        ...
        self.setWindowTitle("StageCounter")
